    ...
    # Configuración libre de CORS para conectar con tu frontend de Netlify
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["*"],
    ...
    # Modelos oficiales de Groq (¡Actualizado el modelo de visión activo!)
    ...
    async def chat_with_bouchi(data: ChatMessage):
        try:
            ...
            # Comprobamos si el usuario ha enviado una cadena de imagen válida
            if data.image_base64 and data.image_base64.strip():
                ...
                # Petición de texto normal con Llama 3.3 si no hay imagen adjunta
                payload = {
                    "model": MODEL_TEXT,
                    "messages": [
